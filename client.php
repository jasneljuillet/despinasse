      ...
      <div class="modal-body">
		<div id="add-client-messages"></div>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
				<label for="clientContact" class="col-sm-3 control-label">Personne &agrave; contacter</label>
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="contact" name="contact" placeholder="Personne &agrave; contacter">
				</div>
			  </div>
			  <div class="form-group">
			   ...
			   <div class="form-group">
				<label for="clientPhone2" class="col-sm-3 control-label"> Autre T&eacute;l&eacute;phone</label>
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="tel" name="tel" placeholder="Autre num&eacute;ro">
				</div>
			  </div>
		...
		<div id="edit-client-messages"></div>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
				<label for="clientContact" class="col-sm-3 control-label">Personne &agrave; contacter</label>
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="contactedit" name="contactedit" placeholder="Personne &agrave; contacter">
				</div>
			  </div>
			   <div class="form-group">
			   ...
			   <div class="form-group">
				<label for="editClientTel" class="col-sm-3 control-label">T&eacute;l&eacute;phone II</label>
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="teledit" name="teledit" placeholder="Phone du client">
				</div>
			  </div>
